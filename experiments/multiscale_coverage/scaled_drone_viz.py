...
class DroneViz(object):
    ...
    def __init__(self, agent_name, scale=.25):
        ...
        self._traj_msg.id = 1
        self._traj_msg.scale.x = self._scale
        self._traj_msg.scale.y = self._scale
        self._traj_msg.scale.z = self._scale
